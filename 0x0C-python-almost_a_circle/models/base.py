...
""" Model defines a base model class. """
import json
import turtle
import csv
...
class Base:
    ...
    __nb_objects = 0
    """ Class variable to keep track of the number of
    instantiated Bases
    """
    ...
    def __init__(self, id=None):
        ...
        if id is not None:
            ...
            """ If no id is provided, increment the count and
            assign it as the id
            """
            Base.__nb_objects += 1
